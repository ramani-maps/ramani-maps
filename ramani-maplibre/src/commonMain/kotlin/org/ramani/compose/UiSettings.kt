...
class UiSettings(
    ...
    val flingAnimationBaseTime: Long = 300L,
    val flingThreshold: Long = 1000L,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (other == null || other !is UiSettings) return false
...
class Margins(val left: Int = 0, val top: Int = 0, val right: Int = 0, val bottom: Int = 0) {
    ...
    override fun equals(other: Any?): Boolean {
        if (this === other) return true
        if (other == null || other !is Margins) return false
